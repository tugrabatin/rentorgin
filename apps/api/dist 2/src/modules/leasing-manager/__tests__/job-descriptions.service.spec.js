...
describe('JobDescriptionsService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get(job_descriptions_service_1.JobDescriptionsService);
    ...
    describe('generateFromLeasingManagerTemplate', () => {
        ...
        it('should throw error if default template not found', async () => {
            ...
            await expect(service.generateFromLeasingManagerTemplate('tenant-1', 'user-1')).rejects.toThrow('Default Leasing Manager template not found');
        });
    });
...
//# sourceMappingURL=job-descriptions.service.spec.js.map