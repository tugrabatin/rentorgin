...
describe('AnalyticsService', () => {
    ...
    describe('getStoreAnalytics', () => {
        ...
        it('should apply filters if provided', async () => {
            ...
            const call = prisma.storeAnalytics.findMany.mock.calls[0][0];
    ...
    describe('getPortfolioSummary', () => {
        it('should calculate portfolio totals correctly', async () => {
            ...
            expect(result.averageRentToRevenueRatio).toBe(20);
    ...
    describe('calculate', () => {
        it('should calculate KPIs correctly', async () => {
            ...
            const expectedKPIs = {
                ...inputData,
                rentToRevenueRatio: 20,
                revenuePerSquareMeter: 1333.33,
            };
