...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: client_1.ExpenseStatus, description: 'Expense status' }),
    (0, class_validator_1.IsEnum)(client_1.ExpenseStatus),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], UpdateExpenseDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Paid date (ISO format)' }),
    (0, class_validator_1.IsDateString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], UpdateExpenseDto.prototype, "paidDate", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Is disputed' }),
    (0, class_validator_1.IsBoolean)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Boolean)
], UpdateExpenseDto.prototype, "isDisputed", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Dispute reason' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.MaxLength)(500),
    __metadata("design:type", String)
], UpdateExpenseDto.prototype, "disputeReason", void 0);
