...
], CreateExpenseDto.prototype, "storeId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: client_1.ExpenseType, description: 'Expense type' }),
    (0, class_validator_1.IsEnum)(client_1.ExpenseType),
    __metadata("design:type", String)
], CreateExpenseDto.prototype, "type", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Expense category (optional)' }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Expense amount', example: 10000.50 }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
], CreateExpenseDto.prototype, "amount", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Currency code', default: 'TRY' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateExpenseDto.prototype, "currency", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Due date (ISO format)', example: '2025-01-15' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Invoice file URL' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
