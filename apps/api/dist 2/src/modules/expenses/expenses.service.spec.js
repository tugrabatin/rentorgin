...
describe('ExpensesService', () => {
    ...
    describe('create', () => {
        ...
        it('should throw NotFoundException if store not found', async () => {
            ...
            await expect(service.create(mockTenantId, createDto)).rejects.toThrow(common_1.NotFoundException);
        });
    });
    describe('findAll', () => {
    ...
    describe('findOne', () => {
        ...
        it('should throw NotFoundException if expense not found', async () => {
            ...
            await expect(service.findOne(mockTenantId, 'invalid-id')).rejects.toThrow(common_1.NotFoundException);
        });
    });
    describe('update', () => {
        it('should update expense successfully', async () => {
            const updateDto = { amount: 12000, status: 'PAID' };
